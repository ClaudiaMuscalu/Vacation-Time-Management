...
<div>
    <div class="row">
        ...
        <div class="col-sm-9 container-center">
            <br>
            <form method="post" action="UpdateLeaveType">
                <br>
                <h3 style="text-align: center;">Update name for a leave type</h3>
                <br>
                <label>The leave type for update:</label>
                <select name="leavetypeid" class="form-control" id="exampleFormControlSelect1">
                    <%
                        LeaveTypeService leaveTypeService = LeaveTypeService.getInstance();
                        ArrayList<LeaveType> leaveTypes = leaveTypeService.getAll();
                        for(LeaveType d: leaveTypes)
                        {
                    %>
                ...
                <div class="form-group">
                    <label>New name for leave:</label>
